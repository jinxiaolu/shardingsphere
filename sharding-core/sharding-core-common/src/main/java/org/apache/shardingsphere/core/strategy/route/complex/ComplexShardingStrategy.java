...
public final class ComplexShardingStrategy implements ShardingStrategy {
    ...
    public Collection<String> doSharding(
        ...
        Collection<String> shardingResult = shardingAlgorithm.doSharding(
                sqlStatementClassName,
                availableTargetNames,
                new ComplexKeysShardingValue(logicTableName, columnShardingValues, columnRangeValues)
        );
