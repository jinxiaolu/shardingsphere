...
public final class ShardingStrategyTest {
    ...
    public void assertDoShardingWithoutShardingColumns() {
        ...
        assertThat(strategy.doSharding(null, targets, Collections.emptySet(), new ConfigurationProperties(new Properties())), is(targets));
    }
    ...
    public void assertDoShardingForBetweenSingleKey() {
        ...
        assertThat(strategy.doSharding(null, targets, Collections.singletonList(new RangeRouteValue<>("column", "logicTable", Range.open(1, 3))), new ConfigurationProperties(new Properties())),
    ...
    public void assertDoShardingForMultipleKeys() {
        ...
        assertThat(strategy.doSharding(null, targets, routeValues, new ConfigurationProperties(new Properties())), is(Sets.newHashSet("1", "2", "3")));
    }
}
